...
#define ORIGINAL_FILE_NAME "UE4Editor-RC_DroneShooterDemo.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME RC_DroneShooterDemo
#define DEPRECATED_FORGAME DEPRECATED
#define RC_DRONESHOOTERDEMO_API DLLEXPORT
